...
class AirplayDevice:
    ...
    def parse_line(self, line):
        ...
        if 'has disconnected from this player.' in line:
            ...
            consumed = True
        # elif line.startswith('Enter Active State.'):
        #     print(f'Active')
        #     self.active = True
        #     consumed = True
        # elif line.startswith('Play Session Begin.'):
        #     print(f'Playtime :)')
        #     self.play_session = True
        #     consumed = True
        # elif line.startswith('Exit Active State.'):
        #     print(f'Not active')
        #     self.active = False
        #     consumed = True
        # elif line.startswith('Play Session End.'):
        #     self.play_session = False
        #     consumed = True
        #     print(f'Playtime over')
